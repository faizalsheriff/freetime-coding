...
public class MyIHealthChallenge {
	...
	public static void main(String[] args) {
	    try {
	        ...
	        "&cholesterolmeds=" + URLEncoder.encode("", "UTF-8") +
	        "&bloodpressuremeds=" + URLEncoder.encode("", "UTF-8") +
	        "&bloodpressuremedcount=" + URLEncoder.encode("", "UTF-8")+
	        "&aspirin=" + URLEncoder.encode("", "UTF-8") +
	        "&moderateexercise=" + URLEncoder.encode("", "UTF-8") +
	        "&vigorousexercise=" + URLEncoder.encode("", "UTF-8") +
	        "&familymihistory=" + URLEncoder.encode("", "UTF-8");
