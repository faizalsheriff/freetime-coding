<%@ taglib prefix="s" uri="/struts-tags" %>
         ...
         <div id="header" data-theme="c" data-role="header" data-position="fixed" class="custom_header" style="display:inline">
            ...
            <!--   	<div class="menuicon left">
				...
				<div class="menuicon right">	
            		 <a href="#" onclick="loadaddmessage()" class="adjust_top">
            	...
            	<!--<div class="tabcontainer">
              	<a id="anchloadlistmsg" href="#" onclick="javascript:loadlistmessages()" style="text-decoration: none"> <div class="lefttab">Messages</div></a>
                <a id="anchloadlistcmp" href="#" onclick="javascript:loadlistcompaigns()" style="text-decoration: none"><div class="righttab">Campaign</div></a>
               	</div>-->

				<!--<div data-role="navbar" data-theme="c">
				<ul>
				<li>
              	<a id="anchloadlistmsg" class="ui-btn-active" href="#" onclick="javascript:loadlistmessages()">Messages</a>
				</li>
				<li>
                <a id="anchloadlistcmp" href="#" onclick="javascript:loadlistcompaigns()">Campaign</a>
				</li>
				</ul>
               	</div> -->
            ...
            <div class="ui-title" role="heading" data-role="controlgroup" data-type="horizontal" aria-level="1">
                <a data-transitions="none"  onclick="javascript:loadlistmessages()" class="ui-btn-active " data-role="button" href="#" data-mini="true" data-inline="true">Messages</a>
                <a data-transitions="none" href="#" onclick="javascript:loadlistcompaigns()" data-role="button" data-mini="true" data-inline="true">Campaign</a>
            </div>
            
            <a href="#" style="margin-top:35px;" class="ui-btn-right" data-transitions="pop"  data-iconpos="notext" data-icon="adds-white" onclick="loadaddmessage()">Compose</a>
         </div>
			...
			<div class="item message">
               ...
               <div class="content">
                    ...
                    <div class="head_tittle">
            			<a href="#"  class="heading" onclick="javascript:viewuserdetails('<s:property value="#msgList.userName"></s:property>')"><s:property value="#msgList.userName"></s:property></a>						
                    </div>
                   ...
                   <s:if test ="%{#msgList.isCurrentUserImpressed==0}">
                    	...
                    	<a class="wow plus" href="#" onclick="messageImpressed('#messageimpressedfrm<s:property value="#msgList.messageId"></s:property>','<s:property value="#msgList.messageId"></s:property>')" data-mini="true" data-inline="true" data-role="button" title="Impressive">Wow&nbsp;+</a>
                    	</s:if>
                    	<s:else>
                    	<a class="wow minus" href="#" onclick="messageUnImpressed('#messageimpressedfrm<s:property value="#msgList.messageId"></s:property>','<s:property value="#msgList.messageId"></s:property>')" data-mini="true" data-inline="true" data-role="button" style="float:right;" title="Un Impressed">Wow&nbsp;-</a>
                    	</s:else>
                   </span>
              </div>
                   <div class="bar">
