<%@ taglib prefix="s" uri="/struts-tags" %>
 <div data-theme="c" data-role="header" data-position="fixed" >
   ...
   <div class="menuicon left">
		  ...
		  <div class="headerbartext">Sign In </div>
		  </div>		
        ...
        <s:property value="uiMessage"></s:property>
           ...
           <!--  <p style="text-align:center;">or</p> -->
            <a href="#" style="background-image: -webkit-gradient(linear, left top, left bottom, from(rgb(199, 244, 253)),to(rgb(12, 217, 245)) );background-image: -webkit-linear-gradient(top, rgb(199, 244, 253), rgb(12, 217, 245));background-image: linear-gradient(top, rgb(199, 244, 253), rgb(12, 217, 245));" onclick="javascript:loadforgotpassword()" data-role="button">Forgot Password ?</a> 
</div>